...
SVC_NAME="actions.runner.cu-ecen-aeld-assignments-3-and-later-IagoErrera.iago.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (cu-ecen-aeld-assignments-3-and-later-IagoErrera.iago)"
