...
SVC_NAME="actions.runner.cu-ecen-aeld-assignment-1-IagoErrera.iago.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (cu-ecen-aeld-assignment-1-IagoErrera.iago)"
